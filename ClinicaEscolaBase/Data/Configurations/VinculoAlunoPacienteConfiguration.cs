...
public class VinculoAlunoPacienteConfiguration : IEntityTypeConfiguration<VinculoAlunoPacienteModel>
{
    public void Configure(EntityTypeBuilder<VinculoAlunoPacienteModel> builder)
    {
